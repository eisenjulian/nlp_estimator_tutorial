...
Finally, we can use a custom initializer function and pass it down to in the `model_fn` to instruct TensorFlow to initialize our embedding variable using this matrix the first time, after which the model will be loaded from a saved checkpoint.
...
AwOjAwXG4iLCJoaXN0b3J5IjpbLTk1Mzk4MTEwMF19
-->