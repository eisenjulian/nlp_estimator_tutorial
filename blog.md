...
Each cell processes one token embedding at a time updating its internal state based on a differentiable computation that depends on both that vector and its previous state. There's a great explanation about the logic behind that at [this post](http://colah.github.io/posts/2015-08-Understanding-LSTMs/) in [Christopher Olah](https://github.com/colah)'s blog. Actually, everthing there is a must read!
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc4MzMxOTAwOF19
-->