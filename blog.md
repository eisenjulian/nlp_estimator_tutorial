...
Each cell processes one token embedding at a time updating its internal state based on a differntiable computation that depends on both that vector and its previous state. There's a great explanation about the logic behind this at 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ5MDA2MDY0M119
-->