...
The following image shows how a filter matrix $F \in \mathbb{R}^{d\times m}$ slides across each $3$-gram window of tokens to build a new feature map. Afterwards a *pooling* layer is usually applied to convine 
...
AwOjAwXG4iLCJoaXN0b3J5IjpbODkwNzA2NDg2XX0=
-->