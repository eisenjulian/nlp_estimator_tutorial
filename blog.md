...
One of the benefits of CNNs over recurrent models is the simple architecture usually provides faster training time and better convergence without much parameter massaging. LSTMs (and RNNs in general) can suffer convergence issues like vanishing or exploding gradients, that said, with enough tweaking they can get state-of-the-art results in many problems. As a rule of thumb CNNs are good at feature extraction, while RNNs excel at tasks that depend on the meaning on the whole sentence and the length of the sentence matters, like question answering or machine trans
...
AwOjAwXG4iLCJoaXN0b3J5IjpbNjQwOTA4NzI3XX0=
-->